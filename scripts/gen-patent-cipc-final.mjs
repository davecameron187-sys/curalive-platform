...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      sH2("14.1. Anomaly Detection with Adaptive Baseline Learning"),
      ...
      sH2("14.2. AI-Powered Root Cause Attribution Engine"),
      ...
      sH2("14.3. Automated Customer Incident Report Generation"),
