...
const doc = new Document({
  sections: [{
    ...
    children: [
      ...
      // FIG 1
      h2("FIG 1 — Overall Platform Architecture"),
      ...[ "+-----------------------------------+",
        "| Vehicle Journey                   |",
      ...
      // FIG 2
      h2("FIG 2 — Communication Architecture"),
      ...[
        "+-----------------------------------+",
      ...
      // FIG 3
      h2("FIG 3 — AI Detection Pipeline"),
      ...[
        "+---------------------------+",
        "| Raw Sensor Signals        |",
        "| (Vehicle + Phone +        |",
      ...
      // FIG 4
      h2("FIG 4 — Learning Feedback Loop"),
      ...[
        "+---------------------------+",
      ...
      // FIG 5
      h2("FIG 5 — In-Vehicle Device Hardware Architecture"),
      ...[
        "+============================================+",
        ...
        "|  +----------+  +----------+  +----------+  |",
        "|  | AI       |  | Secure   |  | Backup   |  |",
        "|  | Processor|  | Storage  |  | Power    |  |",
        "|  +----------+  +----------+  +----------+  |",
        "|                                            |",
        "|  +----------+  +----------+  +----------+  |",
        "|  | Cellular |  | Bluetooth|  | Sub-GHz  |  |",
        "|  | Radio    |  | Radio    |  | Radio    |  |",
        "|  +----------+  +----------+  +----------+  |",
        "|                                            |",
        "|  +----------+  +----------+  +----------+  |",
      ...
      // FIG 6
      h2("FIG 6 — Wearable, Phone, and Vehicle Correlation Engine"),
      ...[
        "+------------+  +------------+  +------------+",
        "| Wearable   |  | Handset    |  | Vehicle    |",
        "| - Location |  | - Location |  | - Location |",
        "| - Motion   |  | - Online?  |  | - Telemetry|",
        "| - Body     |  | - Paired?  |  | - CAN data |",
        "|   contact  |  |            |  |            |",
        "| - Heart    |  |            |  |            |",
        "|   rate     |  |            |  |            |",
        "+-----+------+  +-----+------+  +-----+------+",
      ...
      // FIG 7
      h2("FIG 7 — Voice-Trigger Emergency Workflow"),
      ...[
        "+---------------------------+",
        "| Audio Input (in-vehicle   |",
        "| microphone / phone)       |",
        "+-----------+---------------+",
        "            |",
        "            v",
      ...
      // FIG 8
      h2("FIG 8 — Journey Monitoring and Risk Reclassification"),
      ...[
        "+---------------------------+",
        "| Journey Start             |",
        "| (planned / shared /       |",
        ...
        "            v",
        "+---------------------------+     +---------------------------+",
        "| Route Risk Overlay        | <-- | Hotspot Data / Crime DB   |",
        "+-----------+---------------+     +---------------------------+",
        "            |",
        "            v",
        "+---------------------------+",
      ...
      // FIG 9
      h2("FIG 9 — Response Policy Engine with Staged Escalation"),
      ...[
        "+---------------------------+",
        "| Threat Score Input        |",
        "+-----------+---------------+",
        ...
        "            v",
        "+---------------------------+",
        "| Stage 3: Alert trusted   |",
        "| contacts                 |",
        "+-----------+---------------+",
        "            |",
        "            v",
        "+---------------------------+",
        "| Stage 4: Covert tracking |",
      ...
      // FIG 10
      h2("FIG 10 — Anomaly Scenario: Route Deviation + Trusted Device Changes"),
      ...[
        "+---------------------------+     +---------------------------+",
        "| Vehicle deviates from     |     | Handset goes offline      |",
        "| expected route            |     | (signal lost)             |",
        "+-----------+---------------+     +-----------+---------------+",
        "            |                                 |",
        "            +----------------+----------------+",
        "                             |",
        ...
        "              +-----------------------------+",
        "              | Response Policy Engine      |",
        "              | escalates to Stage 3/4      |",
        "              +-----------------------------+",
      ].map(l => diagramLine(l)),

      // FIG 11
      h2("FIG 11 — Startup Authorization / Protected Lockout / Authenticated Reactivation"),
      ...[
        "+---------------------------+",
      ...
      // FIG 12
      h2("FIG 12 — Predictive Threat Intelligence Pipeline"),
      ...[
        "+---------------------------+     +---------------------------+",
      ...
      // FIG 13
      h2("FIG 13 — Tamper-Resilient Evidence Preservation"),
      ...[
        "+---------------------------+",
        "| Security Incident         |",
        "| Detected                  |",
      ...
      // FIG 14
      h2("FIG 14 — Anti-Jamming Communication Resilience"),
      ...[
        "+---------------------------+",
        "| Signal Degradation        |",
        "| Detected (Cellular +      |",
      ...
      // FIG 15
      h2("FIG 15 — Self-Improving Detection Model Pipeline"),
      ...[
        "+---------------------------+",
      ...
      // FIG 16
      h2("FIG 16 — Occupant Duress Detection and Correlation"),
      ...[
        "+---------------------------+     +---------------------------+",
      ...
      // FIG 17
      h2("FIG 17 — Multi-Vehicle Coordinated Response"),
      ...[
        "+============================================+",
        "|          FLEET NETWORK                     |",
        "+============================================+",
