...
const BASTION_EVENT_TYPES = ["earnings_call", "interim_results", "annual_results", "results_call", "media_call", "capital_markets_day", "investor_day", "roadshow", "special_call"];
  ...
  processTranscript: publicProcedure
    .input(
      z.object({
        ...
        eventType: z.enum([
          "earnings_call", "interim_results", "annual_results", "results_call", "media_call", "agm", "capital_markets_day",
