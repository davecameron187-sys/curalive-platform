...
export function buildReportEmail(opts: {
  ...
  return baseLayout(opts.brand ?? {}, `
    ...
    <table>
      ...
      <tr><th>Compliance Flags</th><td>${opts.complianceFlags}</td></tr>
...
export function buildPreBriefingEmail(opts: {
  ...
  return baseLayout(opts.brand ?? {}, `
    ...
    <p style="font-size:13px;color:#666">This briefing was generated by CuraLive AI based on historical data and market context.</p>
  `);
}
