...
function buildDocDefinition(data: CertificateData) {
  ...
  return {
    ...
    content: [
      ...
      {
        text: "This certificate is generated by the Chorus.AI compliance platform based on data available at the time of issuance. It does not constitute a formal audit opinion and should not be used as a substitute for an independent third-party audit.",
        fontSize: 9,
        color: "#9ca3af",
        lineHeight: 1.5,
      },
