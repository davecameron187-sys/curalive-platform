...
- Client Name, Event Name, Event Type, Platform (Zoom/Teams/Webex/Google Meet/Chorus Call/Other), Meeting URL (auto-detects platform), Notes

### Platforms
- Zoom, Teams, Webex, Google Meet — use Recall.ai bot (now working)
- Chorus Call, Other — Local Audio Capture mode (always worked)
...
| File | Lines | Status |
|---|---|---|
| `client/src/pages/ShadowMode.tsx` | ~400 | ✓ V3 with session creation + END SESSION |
...
| `server/routers/shadowModeRouter.ts` | ~1800 | ✓ Working |
